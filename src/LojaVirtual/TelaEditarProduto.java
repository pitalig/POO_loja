...
public class TelaEditarProduto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jFormattedTextField2.setText(String.valueOf(p.getValor()));
        ...
        jFormattedTextField3.setText(Integer.toString(p.getQuantidadeEstoque()));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("") || jFormattedTextField2.getText().equals("") || jFormattedTextField3.getText().equals("")) {
            ...
            p.setValor(Double.parseDouble(jFormattedTextField2.getText()));
            p.setQuantidadeEstoque(Integer.parseInt(jFormattedTextField3.getText()));
            try {
